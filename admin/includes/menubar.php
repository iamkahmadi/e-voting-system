<aside class="main-sidebar" style="background: linear-gradient(179deg, #060303, #322424);">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      <li class="header" style="background: #a7ff47 !important;">REPORTS</li>
      <li class=""><a href="home.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
      <li class=""><a href="votes.php"><span class="glyphicon glyphicon-lock"></span> <span>Votes</span></a></li>
      <li class="header" style="background: #a7ff47 !important;">MANAGE</li>
      ...
      <li class=""><a href="blogs_admin.php"><i class="fa fa-black-tie"></i> <span>Blogs</span></a></li>
      <li class="header" style="background: #a7ff47 !important;">SETTINGS</li>
